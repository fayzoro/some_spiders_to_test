"""
An interface to html5lib that mimics the lxml.htmls interface.
"""
import sys
import string
...
def fromstring(html, guess_charset=None, parser=None):
    ...
    # document starts with doctype or <htmls>, full document!
    start = html[:50]
    ...
    if start.startswith('<htmls') or start.startswith('<!doctype'):
        return doc
